                          ...
                          success: (res) => {
                            if (res.data.error_msg != '' && res.data.error_msg != "match user is not found" && res.data.error_msg != "SUCCESS") {
                              ...
                              if (res.data.error_msg == "match user is not found") {
                                console.log("你未注册！")
                                wx.request({
                                  url: 'https://aip.baidubce.com/rest/2.0/face/v3/faceset/user/add?access_token=' + that.data.access_token,
                                  method: 'post',
                                  header: {
                                    'Content-Type': 'application/json'
                                  },
